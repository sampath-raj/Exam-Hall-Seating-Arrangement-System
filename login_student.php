...
if(isset($_POST['submit'])){
    ...
    $select_student = "SELECT student_id, name, password, seat_no, hall_no, floor_no FROM students WHERE name='$name' and password='$password'";
...
<head>
    ...
    <style>
        ...
        .submit {
            ...
            border-radius: 5em;
            color: #fff;
            background: linear-gradient(to right, #1976D2, #64B5F6);  /* Blue gradient */
            border: 0;
            padding: 10px 40px;
            margin-top: 10px;
            margin-left: 35%;
...
<body>
    ...
    <div class="main">
        ...
        <form class="form1" method="post">
            ...
            <p align=center class="role-msg">Are you a Admin? <a href="login_admin.php">Login Here</a></p>
    </div>
</body>
</html>